...
exports.Attribute = Attribute; // const attribute = new Attribute<UserProps>({
//     name: 'jose',
//     id: 2,
//     age:4 });
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      // when we dont know what is the object name
      // this.events['asdfgf'] = []
...
var rooUrl = 'http://localhost:3000/users';
...
function () {
  function User(attrs) {
    ...
    this.sync = new Sync_1.Sync(rooUrl);
    this.attributes = new Attribute_1.Attribute(attrs);
  }
...
exports.User = User;
},{"./Attribute":"src/models/Attribute.ts","./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var User_1 = require("./models/User"); // user.set({ name: 'jose' });
// user.set({ age: 12213 });
// user.fetch();
// setTimeout(() => {
//   console.log(user);
...
user.save();
},{"./models/User":"src/models/User.ts"}],"../../Users/bostg/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../Users/bostg/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
